...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-mono-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-mono-900 p-8 rounded-2xl border border-mono-800 shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-mono-400 mb-2">Email</label>
            <input 
              type="email" 
              value={email}
          ...
          <div>
            <label className="block text-sm font-bold text-mono-400 mb-2">Password</label>
            <input 
              type="password" 
              value={password}
